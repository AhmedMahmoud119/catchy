<div id="kt_header" class="header header-fixed shadow-sm">
    <!--begin::Container-->
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
            ...
            <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="" class="brand-logo">
                        <img alt="Logo" style="width: 10%;"
                             src="https://wordpress-1008042-3557977.cloudwaysapps.com/wp-content/uploads/2023/01/catchy-logo.png" class=""/>
                    </a>
                </div>
                <!--end::Header Nav-->
            </div>
        ...
        <div class="topbar">
            ...
            <div class="topbar-item d-lg-none d-block mt-5">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <img class="h-20px w-20px rounded-sm"
                             src="{{asset('metronic/assets/media/svg/flags/226-united-states.svg')}}" alt=""/>
                    </div>
                </div>
                <!--end::Toggle-->
                <!--begin::Dropdown-->
...
{{--                        <!--begin::Item-->--}}
{{--                        <li class="navi-item {{app()->getLocale()=='ar'?'active':''}}">--}}
{{--                            <a href="{{url('/lang/ar')}}" class="navi-link">--}}
{{--                                <span class="symbol symbol-20 mr-3">--}}
{{--                                    <img src="{{asset('metronic/assets/media/svg/flags/158-egypt.svg')}}" alt=""/>--}}
{{--                                </span>--}}
{{--                                <span class="navi-text">egypt</span>--}}
{{--                            </a>--}}
{{--                        </li>--}}
{{--                        <!--end::Item-->--}}
...
{{--    <div class="brand">--}}
{{--        <a href="{{url('/mngrAdmin')}}"><img src="{{settings('logo', false)}}" style="width: 100%;height: 51px;"--}}
{{--                                             alt="{{settings('website_name')}}" class="img-responsive logo"></a>--}}
{{--    </div>--}}
{{--    <div class="">--}}
...
{{--                            <a href="{{url('/lang/ar')}}" class="dropdown-toggle">AR</a>--}}
{{--                        </li>--}}


{{--                        <li class="dropdown notifications-menu">--}}
{{--                            <a href="{{url('/lang/en')}}" class="dropdown-toggle">EN</a>--}}
{{--                        </li>--}}
{{--                    </ul>--}}
{{--                </li>--}}
...
{{--                        <span--}}
{{--                            class="badge bg-danger">{{! empty($count_notification) ? $count_notification : '0'}}</span>--}}
{{--                    </a>--}}
{{--                    <ul class="dropdown-menu notifications">--}}
...
{{--                        <img--}}
{{--                            src="{{ Auth::guard('admin')->user()->image != '' ? Auth::guard('admin')->user()->image : asset('/images/user.png')}}"--}}
{{--                            class="img-circle" alt="Avatar"> <span>{!! Auth::guard('admin')->user()->name !!}</span> <i--}}
{{--                            class="icon-submenu lnr lnr-chevron-down"></i></a>--}}
{{--                    <ul class="dropdown-menu">--}}
{{--                        <li><a href="{!! url('/mngrAdmin/users/'.Auth::guard('admin')->user()->id) !!}"><i--}}
{{--                                    class="lnr lnr-user"></i> <span>{{__('admin.profile')}}</span></a></li>--}}
{{--                        <li><a href="#"><i class="lnr lnr-envelope"></i> <span>Message</span></a></li>--}}
{{--                        <li><a href="#"><i class="lnr lnr-cog"></i> <span>Settings</span></a></li>--}}

{{--                        <li><a href="{!! url('/mngrAdmin/logout') !!}"--}}
{{--                               onclick="event.preventDefault(); document.getElementById('logout-form').submit();">--}}
{{--                                <i class="lnr lnr-exit"></i> {{__('admin.signout')}}--}}
{{--                            </a>--}}
{{--                            <form id="logout-form" action="{{ url('/mngrAdmin/logout') }}" method="POST"--}}
{{--                                  style="display: none;">--}}
{{--                                {{ csrf_field() }}--}}
{{--                            </form>--}}
{{--                        </li>--}}
